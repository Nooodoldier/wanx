...
import com.wanx.common.utils.OrderUtil;
...
public class BookBusService {
    ...
    public PageResult<BookBus> queryBusByPageAndSort(
        ...
        for(BookBus bookBus :list){
            BookStore store = bookStoreFeignService.getBookStoreByIdFeign(bookBus.getBookId());
    ...
    public List<BookBus> getBusList() {
        ...
        if(CollectionUtils.isEmpty(list)){
            ...
            for(BookBus bus :list){
                BookStore store = bookStoreFeignService.getBookStoreByIdFeign(bus.getBookId());
                bus.setBook(store);
            }
        }
        return list;
    ...
    public void addOrder(String ids) {
        ...
        for(String id : ids.split(",")) {
            ...
            bookOrderFeignService.addOrderFeign(order);
        }
